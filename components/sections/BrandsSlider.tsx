...
export default function BrandsSlider() {
  ...
  const brands = [
    ...
    },
    {
      ...
      bgPattern: "radial-gradient(circle at 50% 50%, rgba(255,255,255,0.05) 0%, transparent 50%)",
      accent: "#1D1D1B",
      particles: "🛡️💪🎯",
    },
    {
    ...
    },
    {
      ...
      bgPattern: "radial-gradient(circle at 60% 40%, rgba(255,255,255,0.1) 0%, transparent 50%)",
      accent: "#009639",
      particles: "👟🔧✨",
    },
  ]
  ...
  return (
    <section ref={ref} className="py-24 bg-gradient-to-br from-slate-50 via-gray-50 to-blue-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <motion.h2 
            className="text-5xl md:text-7xl font-black mb-6 bg-gradient-to-r from-gray-900 via-blue-800 to-purple-800 bg-clip-text text-transparent"
            initial={{ scale: 0.8 }}
            animate={isInView ? { scale: 1 } : {}}
            transition={{ duration: 0.8, delay: 0.2 }}
          >
            Shop by <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Brand</span>
          </motion.h2>
          <motion.p 
          ...
          {brands.map((brand, index) => (
            ...
            >
              <motion.div
                ...
                className="bg-white/90 backdrop-blur-lg p-8 rounded-2xl shadow-xl hover:shadow-2xl cursor-pointer relative overflow-hidden border border-white/30 transition-all duration-500"
                style={{
                  transformStyle: "preserve-3d",
                  background: hoveredBrand === index 
                    ? `linear-gradient(135deg, ${brand.color.replace('from-', '').replace('via-', ', ').replace('to-', ', ')})` 
                    : undefined,
                }}
              >
                {/* Animated particles */}
                ...
                {/* Brand logo */}
                <motion.div 
                  className="relative z-10 flex items-center justify-center h-20 mb-4"
                  animate={{
                ...
                <motion.div
                  ...
                  style={{
                    background: `linear-gradient(135deg, ${brand.color.replace('from-', '').replace('via-', ', ').replace('to-', ', ')}), ${brand.bgPattern}`,
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-12 py-4 rounded-full font-bold text-lg shadow-xl hover:shadow-2xl transition-all duration-300 hover:from-blue-700 hover:to-purple-700"
          >
            Explore All Brands
          </motion.button>
        </motion.div>
